	...
	public function _initialize()
		{
    		...
    		$new = M();
    		if ($messagers!=1) {
    			$new -> execute("CREATE TABLE `messager_db`.`messagers` (`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(100) NOT NULL,`note` LONGTEXT NOT NULL,`cdate` DATETIME NOT NULL,`done` INT NOT NULL,PRIMARY KEY (`id`));");
    		}
    		if ($page!=1) {
